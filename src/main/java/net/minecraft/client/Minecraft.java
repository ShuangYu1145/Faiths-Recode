...
//                        Minecraft.getMinecraft().entityRenderer.loadShader(new ResourceLocation("shaders/post/motion_blur.json"));
//                    }
//                    float uniform = 1.0f - Math.min(ModuleMotionBlur.blurAmount.getValue() / 10.0f, 0.9f);
//                    if (Minecraft.getMinecraft().entityRenderer.getShaderGroup() != null) {
