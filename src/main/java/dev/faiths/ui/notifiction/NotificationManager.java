...
//    private final CustomFont fontRendererObj = FontManager.bold18;
    ...
    public void update() {
        for (Notification notification : NOTIFICATIONS) {
            ...
            if (notification.isExtending() && notification.getX() < Math.max(mc.fontRendererObj.getStringWidth(notification.getMessage() + s), mc.fontRendererObj.getStringWidth(notification.getCallReason())) + 16) {
                notification.setX(MathHelper.clamp_double(notification.getX() + 0.25 * ((double) 2000 / Minecraft.getDebugFPS()),0,Math.max(mc.fontRendererObj.getStringWidth(notification.getMessage() + s), mc.fontRendererObj.getStringWidth(notification.getCallReason())) + 16));
